...
- ⏳ **CL4** (deps: CL5 ⏳, CL23) **games carry no genre, year or publisher, so there is no axis to group the grid by** — 14 years, 7 publishers and 5 genres are open, and nearly all of them are entries CL5 has to name or labels CL23 has to settle before a value means anything. → §CL4
